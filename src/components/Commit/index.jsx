  ...
  return (
    <div className={style.commit} id='comment'>
      ...
      <div className='commit-wrap'>
        <img
          src={user ? user.avatarUrl : 'http://s4.music.126.net/style/web2/img/default/default_avatar.jpg?param=50y50'}
          alt=''/>
        <div className='commit-content'>
          <TextArea
            placeholder='评论'
            value={commitText} onChange={handleValueChange}
            maxCount={props.commitLength}/>
