...
import { IconFolder, IconForward, IconPlayCircle, IconPlus, } from '@douyinfe/semi-icons'
...
export default function PlayList(props) {
  ...
  const items = playlist.map((p, i) => (
    ...
    >
      ...
      <span className='creator'>by <Link className='name'
                                         to={'/user/home?uid=' + p.creator.userId}>{p.creator.nickname}</Link></span>
