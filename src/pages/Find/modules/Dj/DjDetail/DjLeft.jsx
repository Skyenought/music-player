...
import { Button, Pagination, Space, Spin } from '@douyinfe/semi-ui'
import { IconDownload, IconForward, IconPlayCircle, IconPlus } from '@douyinfe/semi-icons'
    ...
    <>
      {detail ? <div className={style['dj-left']}>
        ...
        <ul className='list-wrap'>
          {
            list && list.length ? list.map(l => <li
              className={utils.isEven(l.serialNum) ? 'list-item even' : 'list-item'} key={l.id}>
              <div className='col-1'>
              ...
              <div
                className='col-3'>播放{l.listenerCount > 100000 ? parseInt(l.listenerCount / 10000) + '万' : l.listenerCount}</div>
