...
import { IconDownload, IconFolder, IconForward, IconPlayCircle, IconPlus, IconVideo } from '@douyinfe/semi-icons'
...
function Item(props) {
  ...
  return (
    <li className={style['table-item']}>
      ...
      {showAlbum ?
        <div className='album bd ellipsis-1'><Link to={'/find/album?id=' + item.album.id}>{item.album.name}</Link>
        </div> : null}
    </li>
  )
}
