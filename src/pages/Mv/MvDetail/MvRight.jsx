...
import style from '@/pages/Mv/MvDetail/MvRight.module.less'
...
export default function MvRight({ mvDetail }) {
    ...
    <div className={style['mv-right']}>
      <div className='mv-row'>
        ...
        <div className='desc-content'>
          ...
          <div
            className='text'>播放次数：{mvDetail.playCount > 10000 ? parseInt(mvDetail.playCount / 10000) + '万次' : mvDetail.playCount + '次'}</div>
            ...
            <div className='img-wrap'>
              <Link to={'/find/mv?id=' + m.id}>
                ...
                <div className='img-top'>
                  <IconUserCardVideo/>
                  <span
                    className='count'>{m.playCount > 10000 ? parseFloat(m.playCount / 10000) + '万' : m.playCount}</span>
                </div>
              </Link>
            </div>
